document.addEventListener('DOMContentLoaded', function () {
  ...
  const animatedElements = document.querySelectorAll(
    '.fade-in, .scroll-animate, [data-animate], .feature-card, .section-header, .testimonial-card, .pricing-card, .team-member, .gallery-item, .blog-card, .stat-item, .service-card, .hero-content, .about-content, .cta-content'
  );
  ...
  // ============================================================
  // UTILITY: Add CSS for animations if not already in stylesheet
  // ============================================================
  const styleId = 'js-scroll-animation-styles';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '580326b7-3011-43a1-8f03-31fb2faf82dc',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '580326b7-3011-43a1-8f03-31fb2faf82dc';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '580326b7-3011-43a1-8f03-31fb2faf82dc';
